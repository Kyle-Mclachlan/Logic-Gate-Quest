...
var frame_0 = preload("res://art/objects/power/lever off.png") 
var frame_1 = preload("res://art/objects/power/lever on.png")

signal state_changed(state: bool)

# start with signal being false, also check for annotation
func _ready() -> void:
	call_deferred("emit_signal", "state_changed", false)
